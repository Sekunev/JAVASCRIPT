...
const getNews = async function () {
  ...
  // trycatch blogu ile hatayı yönettik. Eğer gelen res başarısız ise yani false ise isError true olsun dedik. (bunu res'deki ok'un true veya false olmasından anlayabiliyorduk.)
  try {
    const res = await fetch(url);
    if (!res.ok) {
      isError = true;
      // throw new Error ile hata fırlatıyoruz.
