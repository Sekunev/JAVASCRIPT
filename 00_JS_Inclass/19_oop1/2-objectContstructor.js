...
//! instance'larin bu metota ulasabilmesidir. Prototypeın varoluş amacı aslında bellegin etkin kullanımını sağlamaktır.
// prototype object'lerin globali gibide düşünülebilir.
...
// book objesine ekleyerek book dan türetilen tüm objelerede price'ı eklemiş olduk.
Book.prototype.price = 100;

// book1'e price ekledik.
// book1.price = 100;
...
console.log(Book.prototype); //objelerin prototypeını görmek için
// console.log(book1.__proto__); //instance prototype görmek için
...
// magazine book objesinden title, author, year'ı Book.call() yöntemi ile inherit ettik. book da olmayanı ise altta tanımladık.
...
// create metodu ile aktardıkdan sonra protatip e yani getSummary ulaştık.
